...
define(["require", "exports", "esri/map", "esri/InfoTemplate", "esri/layers/FeatureLayer", "esri/renderers/SimpleRenderer", "esri/symbols/SimpleFillSymbol", "esri/symbols/SimpleLineSymbol", "dojo/dom", "dojo/number", "dojo/on", "dojo/parser", "esri/Color", "esri/config"], function(require, exports, Map, InfoTemplate, FeatureLayer, SimpleRenderer, SimpleFillSymbol, SimpleLineSymbol, dom, number, on, parser, Color, esriConfig) {
    ...
    var FormatInfowindowController = (function () {
        ...
        FormatInfowindowController.prototype.start = function () {
            try  {
                ...
                infoTemplate.setContent("<b>2007 :D: </b>${POP2007:compare}<br/>" + "<b>2007 density: </b>${POP07_SQMI:compare}<br/><br/>" + "<b>2000: </b>${POP2000:NumberFormat}<br/>" + "<b>2000 density: </b>${POP00_SQMI:NumberFormat}");
                ...
                //apply a renderer
                var symbol = new SimpleFillSymbol(SimpleFillSymbol.STYLE_SOLID, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([255, 255, 255, 0.35]), 1), new Color([109, 146, 155, 0.35]));
                ...
                compare = function (value, key, data) {
                    ...
                    return number.format(value) + "   <img src='" + result + "'/>" + "  <span style='color: " + (pctChange < 0 ? "red" : "green") + ";'>" + number.format(pctChange, { places: 3 }) + "%</span>";
                };
                ...
                compare2 = function (value, key, data) {
                    ...
                    return "<img src='" + result + "'/>" + "  <span style='color: " + (pctChange < 0 ? "red" : "green") + ";'>" + number.format(pctChange, { places: 3 }) + "%</span>";
                };
                ...
                function changeInfoTemplate() {
                    ...
                    if (t1Checked) {
                        templateContent = "<b>2007: </b>${POP2007:compare}<br/>" + "<b>2007 density: </b>${POP07_SQMI:compare}<br/><br/>" + "<b>2000: </b>${POP2000:NumberFormat}<br/>" + "<b>2000 density: </b>${POP00_SQMI:NumberFormat}";
                    } else if (t2Checked) {
                        templateContent = "<b>2007: </b>${POP2007}<br/>" + "<b>2007 density: </b>${POP07_SQMI}<br/><br/>" + "<b>2000: </b>${POP2000:NumberFormat}<br/>" + "<b>2000 density: </b>${POP00_SQMI:NumberFormat}<br/><br/>" + "Diff: ${DIFF:compare2}";
                    }
...
//# sourceMappingURL=FormatInfowindowController.js.map
