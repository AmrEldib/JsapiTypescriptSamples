...
define(["require", "exports", "esri/map", "esri/tasks/locator", "esri/SpatialReference", "esri/graphic", "esri/symbols/SimpleLineSymbol", "esri/symbols/SimpleMarkerSymbol", "esri/symbols/Font", "esri/symbols/TextSymbol", "esri/geometry/Extent", "esri/geometry/webMercatorUtils", "dojo/_base/array", "esri/Color", "dojo/parser", "dojo/dom", "dojo/json", "dijit/registry", "esri/config"], function(require, exports, Map, Locator, SpatialReference, Graphic, SimpleLineSymbol, SimpleMarkerSymbol, Font, TextSymbol, Extent, webMercatorUtils, arrayUtils, Color, parser, dom, JSON, registry, esriConfig) {
    

    var LocatorDetailController = (function () {
        function LocatorDetailController(map) {
            this.map = map;
            parser.parse();
            esriConfig.defaults.io.proxyUrl = "/EsriProxy/proxy.ashx";
        }
        LocatorDetailController.prototype.start = function () {
            try  {
                ...
                locator.on("address-to-locations-complete", function (evt) {
                    ...
                    arrayUtils.forEach(evt.addresses, function (geocodeResult, index) {
                        ...
                        var symbol = new SimpleMarkerSymbol(SimpleMarkerSymbol.STYLE_CIRCLE, 20, new SimpleLineSymbol(SimpleLineSymbol.STYLE_SOLID, new Color([r, g, b, 0.5]), 10), new Color([r, g, b, 0.9]));
        ...
        return LocatorDetailController;
    })();
    return LocatorDetailController;
});
//# sourceMappingURL=LocatorDetailController.js.map
